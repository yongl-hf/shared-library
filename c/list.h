 ...
 */
static inline void list_add_tail(struct list_t *new,
                                 struct list_t *head)
{
 ...
 * the prev/next entries already!
 */
static inline void __list_del(struct list_t *prev,
                              struct list_t *next)
{
    next->prev = prev;
    prev->next = next;
 ...
 * @entry: the element to delete from the list.
 */
static inline void list_del_init(struct list_t *entry)
{
    __list_del(entry->prev, entry->next);
 ...
 */
static inline void list_move(struct list_t *list,
                             struct list_t *head)
{
 ...
 */
static inline void list_move_tail(struct list_t *list,
                                  struct list_t *head)
{
    __list_del(list->prev, list->next);
 ...
 */
static inline int list_empty(struct list_t *head)
{
    return head->next == head;
}

static inline void __list_splice(struct list_t *list,
                                 struct list_t *head)
{
    struct list_t *first = list->next;
    struct list_t *last = list->prev;
    struct list_t *at = head->next;
 ...
 */
static inline void list_splice(struct list_t *list,
                               struct list_t *head)
{
    if (!list_empty(list))
 ...
 */
static inline void list_splice_init(struct list_t *list,
                                    struct list_t *head)
{
    if (!list_empty(list))
    {
 ...
 * @pos:	the &struct list_t to use as a loop counter.
